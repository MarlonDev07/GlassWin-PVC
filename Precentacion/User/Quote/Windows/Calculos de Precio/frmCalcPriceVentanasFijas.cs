        ...
        private void Guardar() 
        {
            ...
            try
            {
                ...
                else 
                {
                    ...
                    if (result)
                    {
                        MessageBox.Show("Ventana Editada Correctamente", "Guardado Correcto", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        ActualizarCotizacion();
                        LimpiarCampos();
                    ...
                    {
                        MessageBox.Show("No se Pudo Editar la Ventana", "Guardado Incorrecto", MessageBoxButtons.OK, MessageBoxIcon.Information);
