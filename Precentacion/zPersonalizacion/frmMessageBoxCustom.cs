...
namespace Precentacion.zPersonalizacion
{
    public partial class frmMessageBoxCustom : Form
    {
        //Fields
        ...
        //Constructors
        public frmMessageBoxCustom(string text)
        {
            InitializeComponent();
            InitializeItems();
        ...
        public frmMessageBoxCustom(string text, string caption)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        public frmMessageBoxCustom(string text, string caption, MessageBoxButtons buttons)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        public frmMessageBoxCustom(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        public frmMessageBoxCustom(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        private void SetIcon(MessageBoxIcon icon)
        {
            switch (icon)
            {
                case MessageBoxIcon.Error: //Error
                    this.pictureBoxIcon.Image = Precentacion.Properties.Resources.error;
